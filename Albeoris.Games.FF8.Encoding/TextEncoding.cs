using Albeoris.Games.FF8.Encoding.Internal;
...
/// the same <see cref="TextEncoding"/> instance can be reused across different fields by
/// reassigning <see cref="FieldCharacters"/> between calls.
/// </remarks>
public sealed class TextEncoding : System.Text.Encoding
{
    private readonly TextEncoder _encoder;
    private readonly TextDecoder _decoder;

    private TextEncoding(Codepage codepage)
    {
    ...
    /// </summary>
    public static TextEncoding CreateEuropean() => new(Codepage.LoadEuropean());

    /// <summary>
    /// Creates an encoding for the Russian release of the game.
    /// </summary>
    public static TextEncoding CreateRussian() => new(Codepage.LoadRussian());
    ...
    /// </summary>
    public static TextEncoding CreateJapanese() => new(Codepage.LoadJapanese());
    ...
    /// </summary>
    public static TextEncoding CreateJapanese(IFieldCharacterProvider fieldCharacterProvider, String fieldName)
    {
        ArgumentNullException.ThrowIfNull(fieldCharacterProvider);

        TextEncoding encoding = CreateJapanese();
    ...
    /// </summary>
    public static TextEncoding CreateJapanese(IFieldCharacterProvider fieldCharacterProvider, Int32 fieldId)
    {
        ArgumentNullException.ThrowIfNull(fieldCharacterProvider);
